package com.harshit.jpaTutorial.module3.controllers;
...
//    }
    ...
    public List<ProductEntity> getAllProducts(
            ...
            @RequestParam(defaultValue = "id") String sortBy,
            @RequestParam(defaultValue = "0") Integer pageNumber){
//        return productRepository.findByOrderByPrice(sortBy);
...
//        ));
        ...
        //findAll is an inbuilt function of Pageable class
//        without getContent, is will return a Page object, so to get only the content part we use getContent()
//        return productRepository.findAll(pageable);

//        return productRepository.findAll(pageable).getContent();

        return productRepository.findByTitleContainingIgnoreCases(title,
